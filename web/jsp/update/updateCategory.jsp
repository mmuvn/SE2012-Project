...
<%-- Admin form page for editing an existing category. --%>
    ...
    <body>
        <div class="site-shell admin-form-shell">
            <section class="auth-card admin-form-card">
                ...
                <p>Edit the selected category record and storefront description.</p>

                <form action="categoryjsp" method="post" class="admin-form">
                    <div class="admin-form-grid">
                        <div class="admin-field">
                            <label for="categoryID">Category ID</label>
                        <input type="text" name="categoryID" id="categoryID" value="${p.categoryID}" placeholder="Enter category ID">
                        </div>
                        <div class="admin-field">
                            <label for="categoryName">Category name</label>
                        <input type="text" name="categoryName" id="categoryName" value="${p.categoryName}" placeholder="Enter category name">
                        </div>
                        <div class="admin-field full">
                            <label for="describe">Description</label>
                        <input type="text" name="describe" id="describe" value="${p.describe}" placeholder="Enter a short category description">
                        </div>
                    </div>
